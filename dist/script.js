...
/* harmony import */ var _modules_openImage__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/openImage */ "./src/js/modules/openImage.js");
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  Object(_modules_openImage__WEBPACK_IMPORTED_MODULE_6__["default"])();
});
  ...
  form.forEach(item => {
    item.addEventListener('submit', e => {
      ...
      postData('assets/server.php', formData).then(res => {
        ...
        clearState();
        document.querySelector('.popup_calc_button').disabled = true;
        document.querySelector('.popup_calc_profile_button').disabled = true; // const fin = 
        ...
        new Promise(resolve => {
          ...
          windows.forEach(item => {
            Object(_closeModal__WEBPACK_IMPORTED_MODULE_1__["default"])(item);
          });
        });
      });
    });
...
/* harmony import */ var _openModal__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./openModal */ "./src/js/modules/openModal.js");
...
const modals = () => {
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    trigger.forEach(item => {
      item.addEventListener('click', e => {
        ...
        windows.forEach(item => {
          Object(_closeModal__WEBPACK_IMPORTED_MODULE_0__["default"])(item);
        });
        Object(_openModal__WEBPACK_IMPORTED_MODULE_1__["default"])(modal);
      });
    ...
    modal.addEventListener('click', e => {
      if (e.target === modal && closeClickOverlay) {
        ...
        Object(_closeModal__WEBPACK_IMPORTED_MODULE_0__["default"])(modal);
      }
    });
  ...
  function showModalByTime(selector, time) {
    setTimeout(function () {
      Object(_openModal__WEBPACK_IMPORTED_MODULE_1__["default"])(document.querySelector(selector));
    }, time);
  }
...
function openImage() {
  ...
  parentImg.addEventListener('click', e => {
    ...
    if (e.target && e.target.classList.contains('preview')) {
      Object(_openModal__WEBPACK_IMPORTED_MODULE_0__["default"])(modalImg, 'flex');
    ...
    if (e.target && e.target.matches('div.popupImg')) {
      Object(_closeModal__WEBPACK_IMPORTED_MODULE_1__["default"])(modalImg);
    }
  });
}

/* harmony default export */ __webpack_exports__["default"] = (openImage);
